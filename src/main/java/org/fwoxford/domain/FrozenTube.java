...
public class FrozenTube extends FrozenTubeLabel implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_frozen_tube")
    @SequenceGenerator(name = "seq_frozen_tube",sequenceName = "seq_frozen_tube",allocationSize = 1,initialValue = 1)
    private Long id;
    /**
     * 项目编码
     */
    ...
    public FrozenTube patientId(String patientId) {
    ...
    public FrozenTube dangerCoefficient(String dangerCoefficient) {
