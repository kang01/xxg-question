...
public class FrozenBoxType extends AbstractAuditingEntity implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_frozen_box_type")
    @SequenceGenerator(name = "seq_frozen_box_type",sequenceName = "seq_frozen_box_type",allocationSize = 1,initialValue = 1)
    private Long id;
    /**
     * 冻存盒类型编码
     */
